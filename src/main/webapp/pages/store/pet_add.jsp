...
<div class="container-fluid">
    ...
    <br><br>
    <form class="form-horizontal" action="PetAdd" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text"  class="form-control"  name="sex"  value="${pet.sex}" required="required">
            </div>
        </div>
        <div class="form-group">
            <label for="input_name" class="col-sm-1 control-label">生日</label>
            <div class="col-sm-6">
                <input type="date" class="form-control"  name="birthday"  value="${pet.birthday}" required="required">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="file" name="img1"   required="required">推荐尺寸: 500 * 500
            </div>
        </div>
        <div class="form-group">
